...
<pre><span style="font-size:18px"><strong>Input:</strong>  S = "(aa(bdc))p(dee)</span><span style="font-size:20px"></span><span style="font-size:18px">"
...
Your task is to complete the function <strong><code>bracketNumbers</code>()&nbsp;</strong>which takes a single string as input and returns a list of numbers. You do not need to take any input or print anything.</span></div>
